...
def add_time(t1,t2):
    ...
    time["mi"]=t1["mi"]+t2["mi"]
    time["se"]=t1["se"]+t2["se"]
    while time["h"]>24 or time["mi"]>=60 or time["se"]>=60 :
        if time["h"]>24.0:
            print("it's more than a day")
            time={"h":0 , "mi": 0 , "se":0}
            break
        elif time["se"]>=60 :
            time["se"]-=60
...
def menu():
    ...
    num1=float(input("hour of enter -> "))
    num2=float(input("minute of enter-> "))
    num3=float(input("second of enetr -> "))
    num4=float(input("hour of exit->"))
    num5=float(input("minute of exit->"))
    num6=float(input("second of exit->"))
